...
const Favorites = (props: Props) => {
  ...
  const items = [
    ...
    {
      avatar: require('../../../assets/images/withdraw.png'),
      name: 'Mercy Cheptoo',
      contact: '0700000000',
    },
    {
      avatar: require('../../../assets/images/buy.png'),
      name: 'Winnie Mwangi',
      contact: '0700000000',
    },
  ];
  return (
    <View>
      <Text style={{...FONTS.body11, textAlign: 'center'}}>FAVORITES</Text>
      ...
      <View style={styles.row}>
        {items.map(item => (
          <View
            ...
            <Image source={item.avatar} style={{alignSelf: 'center',width:40,height:40}}  />
            <Text
              style={{
                marginTop: 10,
                marginLeft: 10,
                ...FONTS.body14,                color:AppColors.darkblue
