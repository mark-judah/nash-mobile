...
import Checkbox from '../../components/withdrawMoneyScreen/checkboxes';
import Favorites from '../../components/withdrawMoneyScreen/favorites';

/**
 *Withdraw Funds UI.
 */
const WithdrawMoney = (props: Props) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Pressable
        ...
        <Text style={{color: '#ffffff', ...FONTS.body1}}>Withdraw</Text>
      </Pressable>
      <BottomNav {...props} />
    </View>
  );
